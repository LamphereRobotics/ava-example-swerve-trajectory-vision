...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final Vector<N3> kStateStdDevs = VecBuilder.fill(0.1, 0.1, 0.1);
  }
  ...
  public static final class LimelightConstants {
    ...
    public static final Vector<N3> kMegaTag1VisionMeasurementStdDevs = VecBuilder.fill(.5, .5, 9999999);
